...
ww3Controllers.controller('platformLangPickSheetCtrl', function ($scope, $modalInstance, $log, $filter, gettext, gettextCatalog) {
    ...
    $scope.infoTooltips = {
        langPick: gettext("Avialable languages for Webble World 3.0. Currently selected is the language you picked or your prefered language in your user profile or the language of your browser, or English."),
        engSubmit: 'Submit',
        engCancel: 'Cancel'
    };
