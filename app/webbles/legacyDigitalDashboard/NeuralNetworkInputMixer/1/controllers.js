//======================================================================================================================
// Controllers for Digital Dashboard Plugin  Neural Network Input Mixer for Webble World v3.0 (2013)
...
wblwrld3App.controller('neuralNetworkInputMixerWebbleCtrl', function($scope, $log, Slot, Enum) {
	...
	$scope.dataSetName = "";
	var preDebugMsg = "Digital Dashboard Neural Network Input Mixer: ";
	...
	//===================================================================================
	// Mix
	// This method mixes the two input slot values into an output.
	//===================================================================================
	function mix() {
		outputValues = [];
	...
	function updateSize() {
		...
		// $log.log(preDebugMsg + "use font size " + fontSize);
		ctx.fillStyle = "black";
