//======================================================================================================================
// Controllers for Digital Dashboard Plugin Neural Network Input for Webble World v3.0 (2013)
...
wblwrld3App.controller('neuralNetworkInputWebbleCtrl', function($scope, $log, Slot, Enum) {
	...
	$scope.dataSetName = "";
	var preDebugMsg = "Digital Dashboard Neural Network Input: ";
	...
	//===================================================================================
	// Parse File
	// This method parses the file it has been given.
	//===================================================================================
