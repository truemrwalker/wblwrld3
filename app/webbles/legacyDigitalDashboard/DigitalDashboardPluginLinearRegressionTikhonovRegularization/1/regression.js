self.addEventListener('message', function(e) {
	...
	linearRegressionThread(data.missingVal, data.coordArrays, data.alpha, self);
    }
}, false);

function linearRegressionThread (missingVal, coordArrays, alpha, thread) {
    // simple "Ordinary least squares"

    // solve for beta
    // beta = invert( transp(X) * X + transp(I*alpha) * I*alpha) * transp(X)*y
