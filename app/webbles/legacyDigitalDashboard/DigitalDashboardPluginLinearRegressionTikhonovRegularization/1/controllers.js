//======================================================================================================================
// Controllers for Digital Dashboard Plugin Linear Regression Tikhonov Webble for Webble World v3.0 (2013)
...
//=======================================================================================
wblwrld3App.controller('linearRegressionTikhonovPluginWebbleCtrl', function($scope, $log, Slot, Enum) {
	...
	$scope.coreCall_Init = function(theInitWblDef){
		...
		$scope.addSlot(new Slot('TikhonovFactor',
			0.5,
			"Tikhonov Factor",
			'The alpha (Tikhonov factor) for the L2 regularization. alpha = 0 leads to normal linear regression.',
			$scope.theWblMetadata['templateid'],
			undefined,
			undefined
		));
	...
	function doBackgroundLinearRegression() {
		...
		var alpha = 0;
		try {
			alpha = parseFloat($scope.gimme('TikhonovFactor'));
		} catch(e) {
			alpha = 0;
		}
	...
	function linearRegressionMainThread () {
		...
		// Tikhonov regularization with I*alpha
		var alpha = 0;
		try {
			alpha = parseFloat($scope.gimme('TikhonovFactor'));
		} catch(e) {
