//======================================================================================================================
// Controllers for Digital Dashboard Plugin Item Set Mining Webble for Webble World v3.0 (2013)
...
wblwrld3App.controller('itemSetMiningPluginWebbleCtrl', function($scope, $log, Slot, Enum) {
	...
	var preDebugMsg = "DigitalDashboard Item Set Mining: ";
	...
	//===================================================================================
	// Mining Finished
	// This method handles the finished mining process.
	//===================================================================================
	function miningFinished(e) {
		// $log.log(preDebugMsg + "miningFinished");
		var data = e.data;
	...
	function newSelection(x1,x2, y1,y2, keepOld) {
		...
		if(unique > 0) {
			...
			for(var s = 0; s < selections.length; s++) {
				...
				if(sel[0] == newSel[0] && sel[1] == newSel[1]) {
	...
	//===================================================================================
	// Check if We Need to Redo Mining
	// This method checks if we need to redo the mining.
	//===================================================================================
	...
	//===================================================================================
	// Do Main Thread Mining
	// This method does the main thread mining.
	//===================================================================================
	function doMainThreadMining() {
		// $log.log(preDebugMsg + "doMainThreadMining");
		FPGrowth();
		sortedRules = [];
		if(!checkSize()) {
			updateGraphics();
	...
	//===================================================================================
	// Do Background Mining
	// This method does the background mining.
	//===================================================================================
	function doBackgroundMining() {
		// $log.log(preDebugMsg + "doBackgroundMining");
		if(miningThread !== null) {
	...
	//===================================================================================
	// FPGrowth
	// This method does FPGrowth mining stuff.
	//===================================================================================
	function FPGrowth()	{
		tooManyItemsGenerated = false;
		var globalSelectionsPerIdSlot = $scope.gimme('GlobalSelections');
	...
	//===================================================================================
	// Is Subset
	// This method checks if the parameters are subsets.
	//===================================================================================
			...
			for(var rn1i = 0; rn1i < FPGrowResult[groupId].length; rn1i++) {
				...
				if (onlyItemSetMining) {
					...
					for(var rn2i = 0; rn2i < FPGrowResult[groupId].length; rn2i++) {
						...
						if (rn1 != rn2  /*OK? Check later*/	&& rn1.items.length < rn2.items.length && rn2.support >= rn1.support * minConfidence) {
	...
	//===================================================================================
	// Recursive FP Extract
	// This method does Recursive FP Extract mining.
	//===================================================================================
	...
	//===================================================================================
	// Make Rules Printable
	// This method makes the rules printable.
	//===================================================================================
	...
	//===================================================================================
	// Rule to String
	// This method converts a rule to a string.
	//===================================================================================
	...
	//===================================================================================
	// Check Size
	// This method checks the text size of a printable rule.
	//===================================================================================
	function checkSize() {
		...
		if(drawW < neededW || drawW - neededW > 200) {
			// $log.log(preDebugMsg + "checkSize() changes width to " + (leftMarg + rightMarg + neededW));
			$scope.set("DrawingArea:width", leftMarg + rightMarg + neededW);
			change = true;
		}
		if(drawH < neededH || drawH - neededH > 200) {
			// $log.log(preDebugMsg + "checkSize() changes height to " + (topMarg + bottomMarg + neededH));
	...
	//===================================================================================
	// Draw Draggable Data Labels
	// This method draws the draggable data labels.
	//===================================================================================
	...
	//===================================================================================
	// Draw Rules
	// This method draws the rules.
	//===================================================================================
	function drawRules(W, H) {
		// $log.log(preDebugMsg + "drawRules");
		ctx.font = fontSize + "px Arial";
