...
module.exports = function(app, config, mongoose, gettext, auth) {
	...
	//
    // Note: The path is just /files/* whereas it should be /api/files/webbles/*
    // This is the only exception to the api directory's path conventions
    // and is kept as is (mostly) for backwards compatibility
    //
